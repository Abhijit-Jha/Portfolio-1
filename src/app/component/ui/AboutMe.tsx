        ...
        <>
            ...
            <motion.div
                ...
                <div className='my-4 w-full max-w-2xl p-4 text-gray-700 dark:text-gray-100 tracking-wide leading-relaxed'>
                    ...
                    I&#39;m Abhijit Jha — an Engineering Student currently in my third year with a strong focus on &nbsp;
                        <Highlighter>
                            <span className='relative z-10 '>full-stack web and mobile development.</span>
                        </Highlighter>
                        I specialize in technologies like JavaScript, React.js, Next.js, Node.js, and React Native with Expo for building cross-platform mobile apps.
